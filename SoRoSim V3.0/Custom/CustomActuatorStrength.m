...
elseif control_type == 6 %6D
    ...
    u = lsqlin(J_tip*(M^-1)*Bq,eta_bar_dot+K_d*(e_eta)+(K_p*(e))+J_tip*(M^-1)*((C+D)*qd+K*q-F)-Jd_tip*qd,[],[],[],[],-50*ones(Tr.n_sact,1),0.001*ones(Tr.n_sact,1),[],options);
