%This toolbox allows the modelling, simulation and control of soft, rigid
%and hybrid robots.
...
disp('Type LinkName=SorosimLink to create the links (joint and body) and follow the instructions')
disp('Type LinkageName=SorosimLinkage(LinkName1,LinkName2,...,LinkNameN) to create linkages (combination of links 1 to N) and follow the instructions')
