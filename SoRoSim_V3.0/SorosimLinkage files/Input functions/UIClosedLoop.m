...
CLjAB = uidropdown(fig,'Position',[150 80 100 22],'Items',{'Revolute','Prismatic','Helical','Universal','Cylindrical','Planar','Spherical','Fixed'});
...
function DoneButtonPushed(btn,Tr,iCL,LinkA,LinkB,CLjAB)
    ...
    if isequal(LinkA.Value,LinkB.Value)
        ...
        for i=1:iB
            ...
            for j=1:Tr.VLinks(Tr.LinkIndex(i)).npie-1
                i_sigB = i_sigB+Tr.VLinks(Tr.LinkIndex(i)).nGauss{j};
            end
        end
